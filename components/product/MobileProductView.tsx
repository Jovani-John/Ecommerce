...
export default function ResponsiveProductView() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-[#FDB913] px-4 py-3 flex items-center justify-between">
        ...
        <h1 className="text-white font-bold text-lg lg:text-xl">T-Shirt</h1>
      ...
      {/* Product Section */}
      <div className="grid lg:grid-cols-2 gap-8 px-4 lg:px-12 py-6">
        {/* Left: Image & Thumbnails */}
        <div>
          <div className="relative bg-gray-100 aspect-square rounded-2xl overflow-hidden shadow-md">
            <img
        ...
        <div className="space-y-6">
          ...
          <button className="w-full bg-[#C89C7C] hover:bg-[#b5896e] transition text-white font-semibold py-4 rounded-lg flex items-center justify-center gap-2 shadow-md">
      ...
      {/* Ratings */}
      <div className="px-4 lg:px-12 py-6 border-t">
